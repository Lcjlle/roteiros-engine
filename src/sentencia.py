...
# corrigiu 22/22 e preservou 6/6 na fixture, sem dependencia nova - ver
# comentario de implementacao da Issue #9 pra tabela completa.
#
# Antes de fechar a Fase A, cinco alternativas foram avaliadas como possivel
# autoridade isolada (troca completa do mecanismo de fusao) e rejeitadas -
# evidencia completa nos comentarios da Issue #9, nao repetida aqui em
# detalhe: `sat-12l-sm` (19/22 open, 2/6 false_positive), `sat-12l` +
# LoRA `ted2020-corrupted` (18/22, 2/6, + 112 fronteiras novas problematicas
# fora da fixture), XLM-R (`Famezz/xlmr-sentence-splitter`, 15/22, 4/6),
# YASBD (`speedyk-005/yasbd-lib`, 22/22, 0/6 - funde vazio/virgula por regra
# categorica) e sentencex (`wikimedia/sentencex`, 22/22, 0/6, mesma causa).
# YASBD e sentencex ficam registrados como evidencia diagnostica, nao como
# dependencia do projeto - nenhum dos dois foi adicionado a `pyproject.toml`.
# A investigacao tambem achou, fora da fixture (nos 15 videos de validacao
# independente), uma classe de defeito diferente - pontuacao terminal
# espuria seguida de minuscula (ex.: "...group cohesion. the ability...") -
# que este fix nao cobre por desenho (so age quando a sentenca NAO termina
# em pontuacao terminal) e que nao deve ser incorporada aqui silenciosamente;
# fica registrada na Issue #9 como direcao futura, sem issue numerada ainda.
